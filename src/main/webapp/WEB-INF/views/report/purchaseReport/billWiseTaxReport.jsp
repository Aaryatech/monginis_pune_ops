 ...
 */
													tr
															.append($(
																	...
																	.html(
																			addCommas((billWiseTaxData.taxableAmt).toFixed(2))));

													tr
															.append($(
																	'<td class="col-md-1" style="text-align:right;"></td>')
																	.html(
																			addCommas((billWiseTaxData.taxRate).toFixed(2))));

													tr
															.append($(
																	'<td class="col-md-1" style="text-align:right;"></td>')
																	.html(
																			addCommas((billWiseTaxData.igstRs).toFixed(2))));

													tr
															.append($(
																	'<td class="col-md-1" style="text-align:right;"></td>')
																	.html(
																			addCommas((billWiseTaxData.cgstRs).toFixed(2))));

													tr
															.append($(
																	'<td class="col-md-1" style="text-align:right;"></td>')
																	.html(
																			addCommas((billWiseTaxData.sgstRs).toFixed(2))));

													tr
															.append($(
																	'<td class="col-md-1" style="text-align:right;"></td>')
																	.html(
																			addCommas((billWiseTaxData.grandTotal).toFixed(2))));

													tr
															.append($(
																	'<td class="col-md-1" style="text-align:right;"></td>')
																	.html(
																			addCommas(billWiseTaxData.cess)));
