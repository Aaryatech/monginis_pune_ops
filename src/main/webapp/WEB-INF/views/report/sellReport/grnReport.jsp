...
<div class="row">
	    <div class="col-md-12"><h2 class="pageTitle">View GRN Report</h2></div>
	</div>
...
{			
	...
	window.open('${pageContext.request.contextPath}/tSellReport?reportURL=pdf/getgrnReportPdf/'+fromDate+'/'+toDate+'/'+frId+'/');
		}
}
