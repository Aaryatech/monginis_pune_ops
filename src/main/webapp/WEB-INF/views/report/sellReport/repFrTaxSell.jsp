...
<div class="row">
	    <div class="col-md-12"><h3 class="pageTitle">View Sell Tax Report</h3></div>
	</div>
	<div class="colOuter">
		<div align="center" >
			...
			$.getJSON('${getTaxSellReport}',{
							...
							function(data) {
							 ...
							 function drawStuff() {
							       ...
							       dataTable.addColumn('string', 'Tax Percent'); // Implicit domain column.
							     ...
							     //  dataTable.addColumn({type:'string', role:'interval'});
							       ...
							       $.each(data,function(key, item) {
									   ...
									   dataTable.addRows([
									             ...
									             [item.tax_per+' %', item.tax_amount, totalTax, ]
...
function genPdf()
{
	...
	window.open('${pageContext.request.contextPath}/pdf?reportURL=pdf/showSellTaxReportpPdf/'+fromDate+'/'+toDate+'/'+frId);
		}
}
