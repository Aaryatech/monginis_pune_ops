	...
	<div class="wrapper">
		...
		<div class="fullGrid center">
			...
			<form name="frm_search" id="frm_search" method="post"
					action="${pageContext.request.contextPath}/insertOtherBill">
								...
								<div id="table-scroll" class="table-scroll">
									...
									<div class="table-wrap table-wrap-custbill">
										<table id="table_grid1" class="main-table small-td">
											...
											<tbody>
											<input type="hidden" id="index${itm.itemId}" name="index" value="0">
											<c:forEach items="${items}" var="itm" varStatus="count">
											
											<tr>
											<input type="hidden" id="cgstPer${itm.itemId}" value="${itm.cgstPer}" placeholder="0" class="form-control" >
											<input type="hidden" id="sgstPer${itm.itemId}" value="${itm.sgstPer}" placeholder="0" class="form-control" >
											<td style="text-align: center">${count.index+1}</td>
											<td style="text-align: center">${itm.itemCode}</td>
											<td style="text-align: center">${itm.itemName}</td>
											<td><input type="text" id="qty${itm.itemId}" onkeyup="changeQty(${itm.itemId})" placeholder="0" class="form-control" ></td>
											<td><input type="text" id="itemRate${itm.itemId}" value="${itm.sellRate}" class="form-control" readonly="readonly"></td>
											<td><input type="text" id="discPer${itm.itemId}" onkeyup="changeQty(${itm.itemId})" value="0" class="form-control" ></td>
											<td style="text-align: center" id="disc_amt${itm.itemId}">00</td>
											<!-- <td style="text-align: center" id="amt"></td> -->
											<td style="text-align: center" id="tax_rate${itm.itemId}">00</td>
											<td style="text-align: center" id="total_amt${itm.itemId}">00</td>
											<td style="text-align: center" id="grndTotal${itm.itemId}">00</td>
											</tr>
											</c:forEach>
											</tbody>
