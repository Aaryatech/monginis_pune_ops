			...
			function searchStock() {
				...
				$.getJSON('${getStock}', {
					...
					if(isMonthClose && selectedStockOption == 1){
						...
						tr.append($('<th align=center>Regular Opening Stock</th>'));
						tr.append($('<th align=left>Special Opening Stock</th>'));

						
						tr.append($('<th align=left>Reg Purchase Qty</th>'));
						tr.append($('<th align=left>Sp Purchase Qty</th>'));
						...
						tr.append($('<th align=left>Regular Current Stock</th>'));
						tr.append($('<th align=center>Special Current Stock</th>'));

						tr.append($('<th align=left>Physical Stock</th>'));
						
						tr.append($('<th align=left>Stock Difference</th>'));
